                ...
                <div class="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
                    ...
                    <div class="mb-6">
                        <div id="camera-container"
                             class="relative bg-gray-900 rounded-2xl overflow-hidden aspect-square">
                            ...
                            <div class="absolute inset-0 flex items-center justify-center">
                                <div class="w-64 h-64 border-4 border-white border-dashed rounded-2xl relative">
                                    <div
                                        class="absolute top-0 left-0 w-8 h-8 border-t-4 border-l-4 border-blue-500 rounded-tl-2xl"></div>
                                    <div
                                        class="absolute top-0 right-0 w-8 h-8 border-t-4 border-r-4 border-blue-500 rounded-tr-2xl"></div>
                                    <div
                                        class="absolute bottom-0 left-0 w-8 h-8 border-b-4 border-l-4 border-blue-500 rounded-bl-2xl"></div>
                                    <div
                                        class="absolute bottom-0 right-0 w-8 h-8 border-b-4 border-r-4 border-blue-500 rounded-br-2xl"></div>
                                    {{-- Scanning line animation --}}
                                    <div
                                        class="absolute inset-x-4 top-4 h-1 bg-gradient-to-r from-transparent via-blue-500 to-transparent animate-pulse"></div>
                                </div>
                            </div>

                            {{-- Status overlay --}}
                            <div id="status-overlay"
                                 class="absolute inset-0 bg-black bg-opacity-75 flex items-center justify-center text-white text-xl font-bold hidden">
                                <div class="text-center">
                                    <div
                                        class="animate-spin w-8 h-8 border-4 border-white border-t-transparent rounded-full mx-auto mb-4"></div>
                        ...
                        <div class="flex justify-center gap-4 mt-4">
                            ...
                            <button id="stop-camera"
                                    class="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors">
                                ⏹️ Stop Camera
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <form id="manual-form" class="space-y-4">
                            @csrf
                            <div>
                                <label for="booking-code" class="block text-sm font-medium text-gray-700 mb-2">Booking
                                    Code</label>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label for="validator-name" class="block text-sm font-medium text-gray-700 mb-2">Nama
                                        Validator</label>
                                ...
                                <div>
                                    <label for="entry-gate" class="block text-sm font-medium text-gray-700 mb-2">Pintu
                                        Masuk</label>
